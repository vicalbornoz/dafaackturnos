...
- turnos-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- turnos-ui: main application module, development time
- turnos-production: module that produces a production mode WAR for deployment
