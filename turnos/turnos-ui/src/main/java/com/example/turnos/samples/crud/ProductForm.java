package com.example.turnos.samples.crud;

import java.util.Collection;

import com.example.turnos.samples.backend.DataService;
import com.example.turnos.samples.backend.data.Availability;
import com.example.turnos.samples.backend.data.Category;
import com.example.turnos.samples.backend.data.Product;
